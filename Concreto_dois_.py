...
class Momento():
    ...
    def __init__(self,codigo,formula_tramo_A,formula_tramo_B,formula_tramo_C,valores_constantes) -> None:
        ...
        try:
            ...
            self.tramo_A = self.Tramo_A(valores_constantes,self.formula_tramo_A)
        except:
            pass
        try:
            self.formula_tramo_B = sp.sympify(formula_tramo_B) # um string q se resolve com sp.sympify
            self.tramo_B = self.Tramo_B(valores_constantes,self.formula_tramo_B)
        except:
            pass
        try:
            self.formula_tramo_C = sp.sympify(formula_tramo_C) # um string q se resolve com sp.sympify
            self.tramo_C = self.Tramo_C(valores_constantes,self.formula_tramo_B)
        except:
            pass
...
print(m.tramo_A.posicao(6995.098))
